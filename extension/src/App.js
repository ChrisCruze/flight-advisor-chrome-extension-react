...
const getFlightDelay = ({ setResponse, url }) => {
  //const url = `https://e553-34-83-235-2.ngrok.io/delay_frequency/origin=MEM&destination=IAH&airline=UA`;
  const options = {
    url: url,
    method: "GET",
    headers: {
...
const createURLFromForm = ({ formData }) => {
  ...
  const url = `https://e553-34-83-235-2.ngrok.io/delay_frequency/origin=${origin}&destination=${destination}&airline=${airline}`;
  return url;
};
const App = () => {
